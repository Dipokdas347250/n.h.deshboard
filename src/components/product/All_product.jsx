...
const All_product = () => {
  ...
  const [form, setForm] = useState({ title: "", description: "", price: "", sku: "", images: [] });
  ...
  const startEdit = (product) => {
    ...
    setForm({ title: product.title || "", description: product.description || "", price: product.price || "", sku: product.sku || "", images: [] });
  };
